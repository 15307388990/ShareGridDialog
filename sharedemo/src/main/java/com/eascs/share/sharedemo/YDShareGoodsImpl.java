...
public class YDShareGoodsImpl extends ShareGridDialogImpl {
    public YDShareGoodsImpl(Activity activity, ShareCallback shareCallback) {
        super(activity, shareCallback);
    }

    public YDShareGoodsImpl(Activity activity) {
        super(activity);
    }
    ...
    public void onItemClick(View view, int position, ShareItemVM shareItemVM) {
        ...
        if (("图文下载").equals(shareItemVM.getTitle())) {
            shareCallback.onComplete("图文下载");
